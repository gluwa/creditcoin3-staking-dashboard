...
import CreditcoinLogoMini from 'img/creditcoinLogoMini.svg?react';
import CreditcoinLogoNormal from 'img/creditcoinLogoNormal.svg?react';
...
export const Main = () => {
  ...
  return (
    <>
      ...
      >
        {sideMenuMinimised ? <CreditcoinLogoMini /> : <CreditcoinLogoNormal />}
      </LogoWrapper>
