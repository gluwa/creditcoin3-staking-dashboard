...
export const PagesConfig: PagesConfigItems = [
  {
    ...
    hash: '/overview',
    Entry: Overview,
    icon: () => <OverviewIcon width={'13'} height={'11'} />,
  },
  {
    category: 2,
    key: 'pools',
    ...
    hash: '/pools',
    Entry: Pools,
    icon: () => <PoolsIcon height={'14'} width={'14'} />,
  },
  {
    category: 2,
    key: 'nominate',
    ...
    hash: '/nominate',
    Entry: Nominate,
    icon: () => <NominateIcon width={'14'} height={'8'} />,
  },
  {
    category: 2,
    key: 'payouts',
    ...
    hash: '/payouts',
    Entry: Payouts,
    icon: () => <PayoutsIcon width={'14'} height={'12'} />,
  },
  {
    category: 3,
    key: 'validators',
    ...
    hash: '/validators',
    Entry: Validators,
    icon: () => <ValidatorsIcon width={'13'} height={'13'} />,
  },
  {
    category: 3,
    key: 'community',
    ...
    hash: '/community',
    Entry: Community,
    icon: () => <CommunityIcon width={'14'} height={'14'} />,
  },
];
